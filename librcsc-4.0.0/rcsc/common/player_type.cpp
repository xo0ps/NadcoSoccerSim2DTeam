                                         ...
                                         const double & effort ) const
{
    ...
    if ( required_power > sparam.maxDashPower() )
    {
        required_power = sparam.maxDashPower();
    }
...
void
PlayerType::predictStaminaAfterOneDash( const ServerParam & sparam,
                                        const double & dash_power,
                                        double * stamina,
                                        double * effort,
...
*/
void
PlayerType::predictStaminaAfterDashes( const ServerParam & sparam,
                                       const double & dash_power,
                                       const int n_dash,
                                       double * stamina,
                                       double * effort,
                                       double * recovery ) const
{
    ...
    *stamina -= one_cycle_consumpation * n_safety_dash;
    ...
    {
        predictStaminaAfterOneDash( sparam, dash_power, stamina, effort, recovery );
    }
}
