                 ...
                 int * cpp )
{
    ...
    if ( *width % rcsc::TeamGraphic::TILE_SIZE != 0
         ...
         || *cpp != 1 )
    {
        std::cerr << __FILE__ << ' ' << __LINE__
                  ...
                  << " nr_colors=" << *n_color
                  << " cpp=" << *cpp
                  << "\n  Width must be " << rcsc::TeamGraphic::TILE_SIZE
                  << " x N and less then equal " << rcsc::TeamGraphic::MAX_WIDTH
                  << "\n  Height must be " << rcsc::TeamGraphic::TILE_SIZE
                  << " x N and less then equel " << rcsc::TeamGraphic::MAX_HEIGHT
                  << "\n  The number of color must be less than equal " << rcsc::TeamGraphic::MAX_COLOR
